...
NUMBER_RECENT_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_RECENT_ENTRIES', 5)
NUMBER_FEATURED_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_FEATURED_ENTRIES', 5)
NUMBER_DRAFT_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_DRAFT_ENTRIES', 5)
NUMBER_RANDOM_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_RANDOM_ENTRIES', 5)
NUMBER_POPULAR_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_POPULAR_ENTRIES', 5)
NUMBER_SIMILAR_ENTRIES = getattr(settings, 'ZINNIA_NUMBER_SIMILAR_ENTRIES', 5)
